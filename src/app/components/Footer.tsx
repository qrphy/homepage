...
export default function Footer() {
  return (
    <footer className="fixed bottom-1 left-1/2 -translate-x-1/2 pt-1 pb-1 bg-black text-sm rounded-4xl -translate-y-14 max-w-sm mx-auto px-4 shadow-lg shadow-gray-900/60 text-white underline-offset-3 md:pt-2 md:pb-2 md:text-md md:max-w-md">
